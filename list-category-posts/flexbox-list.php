<?php
/*
Plugin Name: List Category Posts - Template "Flexbox List"
Plugin URI: http://picandocodigo.net/programacion/wordpress/list-category-posts-wordpress-plugin-english/
Description: Template file for List Category Post Plugin for Wordpress which is used by plugin by argument template=flexbox-list.php
Version: 0.9
...
$lcp_display_output .= '<ul class="lcp_catlist flexbox-list-parent">';
...
while ( have_posts() ):
  ...
  $lcp_display_output .= "<li class='flexbox-item'>";
  ...
  // Start tag for initial view
  $lcp_display_output .= '<div class="show">';
  //Post Thumbnail
  $lcp_display_output .= $this->get_thumbnail($post);
  // End tag for initial view
  $lcp_display_output .= '</div>';

  // Start tag for hover view
  $lcp_display_output .= '<div class="onhover">';
  //Show the title and link to the post:
  // $lcp_display_output .= $this->get_post_title($post, 'h3', 'lcp_post');
  // Wrapper for centering
  $lcp_display_output .= '<div class="center">';
  // Show the excerpt
  $lcp_display_output .= $this->get_excerpt($post, 'div', 'lcp_excerpt');
  // Get Posts "More" link:
  $lcp_display_output .= '<a href="' . site_url($post->post_name) . '" class="btn laurel-btn">'. 'Learn More' . '</a>';
  // Close wrapper for centering
  $lcp_display_output .= '</div>';
  // $lcp_display_output .= $this->get_posts_morelink($post, 'button', 'btn laurel-purple');
  // End tag for hover view
  $lcp_display_output .= '</div>';
